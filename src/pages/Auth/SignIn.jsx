    ...
    <header className='relative overflow-clip h-full py-10 sm:py-20'>
      ...
      <main className='max-w-screen-xl mx-auto px-4 pt-16 flex justify-between'>
        ...
        <div className="w-full lg:w-5/12 bg-skin-surface px-4 py-6 sm:p-6 rounded-2xl space-y-8">
            <h3 className='text-2xl font-semibold text-skin-base'>Sign in to your account</h3>
            {/* Social media Signin */}
            ...
            <div className='relative'>
              ...
              <div className='text-sm text-skin-base flex justify-center'>
                <p className='bg-skin-surface px-3 absolute -top-2.5'> Or, Sign in with your email</p>
              </div>
            </div>
            {/* Form */}
            <form action="" className='space-y-4'>
              ...
              <div>
                <a href="/forgotpassword" className='block text-skin-muted hover:text-skin-base text-right font-medium underline'>Forgot your password?</a>
              </div>
              {/* Form Submit Button */}
              <div className='pt-5 space-y-3'>
                  <button className='w-full h-14 font-medium bg-skin-primary rounded-lg'>Sign in</button>
